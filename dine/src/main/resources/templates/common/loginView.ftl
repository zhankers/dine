            ...
            <div class="ms-auth-col">
                <div class="ms-auth-form">
                    <form class="needs-validation" method="post" action="${springMacroRequestContext.contextPath}/admin/loginAdmin" novalidate="">
                        ...
                        <div class="mb-3">
                            <label for="login-username">Tel Number</label>
                            <div class="input-group">
                                <input type="tel" class="form-control" id="login-username" name="phone" placeholder="Tel Number" required="" pattern="^1(3|4|5|7|8)\d{9}$">
                        ...
                        <div class="mb-2">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control" id="login-password" name="password" placeholder="Password" required="" pattern="^[0-9A-Za-z]{6,20}$">
